        ...
        <div className='bg-dark px-3 py-5'>
            <div className='row container-fluid g-5 mx-auto text-white justify-content-between'>
                ...
                <div className='col-md-2'>
                    <h6>QUICK LINKS</h6>
                    <hr />
                    <Link className='d-block text-decoration-none text-muted' to='/home'>Home</Link>
                    <Link className='d-block text-decoration-none text-muted' to='/home'>Pricing</Link>
                    <Link className='d-block text-decoration-none text-muted' to='/home'>Services</Link>
                    <Link className='d-block text-decoration-none text-muted' to='/home'>Contact Us</Link>
                </div>
                <div className='col-md-3'>
                    <h6>NEWSLETTER</h6>
                    <hr />
